...
docker run -v $(pwd):/attachments --rm shreddedbacon/mail-docker bash -c "sendEmail -u $SUBJECT_EMAIL -m $CONTENT_EMAIL -f $FROM_EMAIL -t $TO_EMAIL -s $SMTP_EMAIL -o tls=yes -xu $USER_SMTP -xp $PASSWD_SMTP"
```
